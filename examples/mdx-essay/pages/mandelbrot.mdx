...
import { MandelbrotInteractive } from "../components/mandelbrot-interactive";
import { createState, Observe, Input } from "mdx-state";
import { InlineMath, BlockMath } from "react-katex";
import "katex/dist/katex.min.css";
import "../components/node_modules/interactive.css"
...
export const example3 = createState({ x: -0.5, y: 0.5, iterations: 15 });

<Observe state={example3}>
{state => <div className="flex gap-10">
	<div className="grid">
		<Mandelbrot iterations={example3.iterations} className="col-span-full row-span-full" />
	...
	<div className="text-base flex items-center">
	<p>Finally, a diagram of the Mandelbrot Set after {state.iterations} number of iterations<br/>
		<Input type="range" min="1" max="100" state={example3} name="iterations" /> 
	</p>
	</div>
</div>}
</Observe>

The more we increase the number of iterations, the closer we get to the true form of the Mandelbrot Set.

Lastly, we get the fully interactive widget of the mandelbrot, have fun:
